...
// //do we want get all friends or all users?
...
//   const current =  new Date().toLocaleString(); //date
//   const currentDate = new Date().toLocaleDateString();//time
...
//     const uploads = fs.readdirSync('/public/uploads')//return array of file names
//     //loop through uploads and find the file name === 3-times-missed habit then send res to front end to render the video. 
// }; 
